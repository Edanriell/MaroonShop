...
const IndividualCare = ({ title }: Props) => {
	...
	return (
		<div className="pt-[8rem] pb-[8rem] pl-[1.5rem] pr-[1.5rem] md:pt-[12rem] md:pb-[12rem] lg:pt-[14rem] lg:pb-[14rem] md:mr-auto md:ml-auto md:pl-[4.5rem] md:pr-[0rem] lg:pl-0 lg:pr-0 lg:mr-auto lg:ml-auto">
			<div className="flex flex-col items-stretch md:flex-row md:items-center md:justify-between lg:justify-center">
				<div className="pt-[5.2rem] pb-[11rem] flex flex-col items-center bg-pampas-50 md:pt-[5rem] md:pb-[6rem] md:pl-[6rem] md:pr-[25.5rem] md:items-start lg:pt-[9rem] lg:pb-[10rem] lg:pl-[10rem] lg:pr-[22.1rem] md:mr-[-22.8rem] lg:mr-[-17rem]">
				...
				<Card3d classes="sm:self-center md:self-auto mt-[-6rem] md:mt-[0rem]">
					<picture className="">
						...
						<img
							...
							alt=""
							className="w-[25rem] h-[25.2rem] object-cover md:w-[28.2rem] md:h-[40.3rem] lg:w-[67rem] lg:h-[45.1rem]"
						/>
					</picture>
				</Card3d>
			</div>
