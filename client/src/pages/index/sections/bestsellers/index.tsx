...
const Bestsellers = ({ title }: Props) => {
	...
	return (
		<div className="container pt-[7.2rem] pb-[8rem] relative md:grid md:grid-rows-5-auto md:grid-cols-bestsellers-two md:gap-x-[4rem] md:pl-[4.5rem] md:pr-[0rem] md:mr-[auto] md:ml-[auto] md:pt-[12rem] md:pb-[12rem]">
			<header className="flex flex-col gap-y-[1.15rem] mb-[4.45rem] items-center md:col-start-1 md:col-end-2 md:row-start-1 md:row-end-3 md:gap-y-[1.4rem] md:mb-0 md:items-start md:mt-[4.6rem]">
			...
			<div className="mt-[4rem] text-center md:col-start-1 md:col-end-2 md:row-start-3 md:row-end-4 md:text-left md:mt-[3.35rem]">
				<Button type="link-internal" text="Смотреть все" linkInternal="/" />
			</div>
		</div>
	);
};
